...
def build_public_index() -> str:
    ...
    html = html.replace('/static/styles.css?v=10.6.0', 'styles.css?v=10.6.0')
    html = html.replace('/static/dashboard.js?v=10.6.0', 'dashboard.js?v=10.6.0')
    html = html.replace('/static/student_profile_data.js?v=10.6.0', 'student_profile_data.js?v=10.6.0')
    ...
    html = html.replace(
        '<script src="dashboard.js?v=10.6.0"></script>',
        '<script src="data.js?v=10.6.0"></script>\n  <script src="dashboard.js?v=10.6.0"></script>',
    )
    return html
