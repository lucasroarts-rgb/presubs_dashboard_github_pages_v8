...
def build_public_index() -> str:
    ...
    html = html.replace('/static/styles.css?v=10.6.2.1', 'styles.css?v=10.6.2.1')
    html = html.replace('/static/dashboard.js?v=10.6.2.1', 'dashboard.js?v=10.6.2.1')
    html = html.replace('/static/student_profile_data.js?v=10.6.2.1', 'student_profile_data.js?v=10.6.2.1')
    ...
    html = html.replace(
        '<script src="dashboard.js?v=10.6.2.1"></script>',
        '<script src="data.js?v=10.6.2.1"></script>\n  <script src="dashboard.js?v=10.6.2.1"></script>',
    )
    return html
